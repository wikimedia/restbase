 ...
 */
rbUtil.copyForwardedHeaders = function(restbase, req) {
    if (restbase.forwardedHeaders) {
        req.headers = req.headers || {};
        Object.keys(restbase.forwardedHeaders).forEach(function(header) {
            if (!req.headers[header]) {
                req.headers[header] = restbase.forwardedHeaders[header];
            }
        });
    }
    return req;
