...
RESTBase.prototype._request = function(req) {
    ...
    if (self.parentReq && self.parentReq.headers) {
        childReq.headers = childReq.headers || {};
        Object.keys(self.parentReq.headers).filter(function(header) {
            return header.toLowerCase() === 'cookie';
        })
        .forEach(function(header) {
            childReq.headers[header] = self.parentReq.headers[header];
        })
    }
