...
var BackendRequestHandler = require('./genericReqHandler');
    ...
    .then(function() {
        ...
        Object.keys(pathspec).forEach(function(methodName) {
            ...
            if (backendRequest) {
                ...
                var backendHandler = new BackendRequestHandler(backendRequest);
                backendHandler.resources.forEach(function(r) { node.value.resources.push(r); });
                node.value.methods[methodName] = backendHandler.handler.bind(backendHandler);
