...
function buildFromYaml(src) {
  try {
    console.log('attempting to parse spec as yaml');
    var YAML = window.YAML
    var data = YAML.parse(src);
    return data;
  } catch (e) {
    console.log('failed to parse spec as yaml', e);
    return null;
  }
}

function buildFromJson(src) {
  try {
    console.log('attempting to parse spec as json');
    return JSON.parse(src);
  } catch (e) {
    console.log('failed to parse spec as json', e);
    return null;
  }
}
  ...
  var obj = {
    ...
    on: {
      ...
      response: function(resp) {
        ...
        var responseObj = resp.obj || buildFromJson(resp.data) || buildFromYaml(resp.data);
