...
const errCodes = {
    ...
    'readinglists-db-error-empty-order': errDefs['400'],
    'readinglists-db-error-missing-list': errDefs['400'],
    'readinglists-db-error-missing-list-entry': errDefs['400'],
    'readinglists-db-error-entry-not-in-list': errDefs['400'],
